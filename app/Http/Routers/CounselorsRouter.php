...
class CounselorsRouter implements RouterInterface {
    public static function setRoutes() {
      ...
      Route::post('/counselors/{counselor}/edit', 'CounselorsController@update');
      ...
      Route::get('/counselors/{counselor}/badges/edit', 'BadgesController@edit');
      Route::post('/counselors/{counselor}/badges/edit', 'BadgesController@remove');
      // TODO: Fix this route
